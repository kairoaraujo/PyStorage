...
class VNX(object):
    ...
    def _init_vnx(self):
        ...
        init_command = '{0} -h {1} -addusersecurity -user {2} ' \
                       '-password {3} -scope {4}'.format(self.naviseccli_path,
                                                         self.fst_address,
                                                         self.user,
                                                         self.password,
                                                         self.scope)
        runsub.cmd(init_command)
    ...
    def create_dev(self, address=None, lun_size=None, pool_name=None,
        ...
        create_dev_cmd = "echo {0} -h {1} lun -create -type {6} -capacity {2} " \
                         "-sq gb -poolName {3} -aa {4} -name {5}".format(
            self.naviseccli_path,
            address,
            lun_size,
            pool_name,
    ...
    def mapping_dev(self, stggroup='None', hlu='None', alu='None'):
        ...
        mapping_dev_cmd = "echo {0} -h {1} -user {2} -password {3} -scope {4} " \
